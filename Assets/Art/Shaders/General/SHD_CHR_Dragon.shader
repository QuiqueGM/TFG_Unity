Shader "DragonCity2/Generic Dragon"
{
    Properties
    {
        ...
        [NoScaleOffset]_DissolveNoiseTexture("Dissolve Noise Texture", 2D) = "white" {}
        _DissolveEffectAmount("Dissolve Effect Amount", Range(0, 1)) = 0
        [HDR]_DissolveColor("Dissolve Color", Color) = (4.864069, 0.3104725, 0, 0)
        _DissolveEdge("Dissolve Edge", Range(0, 0.1)) = 0.04
        _DissolveScale("Dissolve Scale", Range(0, 2)) = 1
    ...
    SubShader
    {
        ...
        //#pragma multi_compile _ SHADOWS_SHADOWMASK
            ...
            #pragma shader_feature SHADER_MODULE_DISSOLVE

            // Defines
            #ifdef SHADER_MODULE_DISSOLVE
                #define _AlphaClip 1
            #endif
        ...
        float4 _DissolveNoiseTexture_TexelSize;
        half _DissolveEffectAmount;
        ...
        void Unity_Step_float4(half4 Edge, half4 In, out half4 Out)
        {
            Out = step(Edge, In);
        }

        struct Bindings_SGDissolve_a81582b475e10fe4486ffab091bc6d5a
        {
            float3 WorldSpaceNormal;
            float3 WorldSpacePosition;
            float3 AbsoluteWorldSpacePosition;
        ...
        void SG_SGDissolve_a81582b475e10fe4486ffab091bc6d5a(UnityTexture2D Texture2D_49bc656924cd4933bccc94e4303678a9, float Vector1_1d4f7fef1cba451f9cf10522fd3cf41c, float Vector1_37122b6736f7434cb407cb0f5f4d3125, float Vector1_5528bdf3ce344a5fbed51ae6082bac7d, float4 Vector4_98655957cd264f8ebfa9f2492dc3c26f, Bindings_SGDissolve_a81582b475e10fe4486ffab091bc6d5a IN, out float AlphaClip_3, out float Alpha_1, out float4 Emissive_2)
        {
            float _Property_f85671438b7d45abaf35ef1761c4ba5b_Out_0 = Vector1_1d4f7fef1cba451f9cf10522fd3cf41c;
            UnityTexture2D _Property_4b3a3b0c41d7466785460340bbd143d2_Out_0 = Texture2D_49bc656924cd4933bccc94e4303678a9;
            float _Property_0bfda49fe9e1410b992ad2aafce77ecb_Out_0 = Vector1_37122b6736f7434cb407cb0f5f4d3125;
            float3 Triplanar_4600f8d10fcb481bb9243c505081d88e_UV = IN.AbsoluteWorldSpacePosition * _Property_0bfda49fe9e1410b992ad2aafce77ecb_Out_0;
            float3 Triplanar_4600f8d10fcb481bb9243c505081d88e_Blend = SafePositivePow_float(IN.WorldSpaceNormal, min(1, floor(log2(Min_float())/log2(1/sqrt(3)))) );
            Triplanar_4600f8d10fcb481bb9243c505081d88e_Blend /= dot(Triplanar_4600f8d10fcb481bb9243c505081d88e_Blend, 1.0);
            float4 Triplanar_4600f8d10fcb481bb9243c505081d88e_X = SAMPLE_TEXTURE2D(_Property_4b3a3b0c41d7466785460340bbd143d2_Out_0.tex, _Property_4b3a3b0c41d7466785460340bbd143d2_Out_0.samplerstate, Triplanar_4600f8d10fcb481bb9243c505081d88e_UV.zy);
            float4 Triplanar_4600f8d10fcb481bb9243c505081d88e_Y = SAMPLE_TEXTURE2D(_Property_4b3a3b0c41d7466785460340bbd143d2_Out_0.tex, _Property_4b3a3b0c41d7466785460340bbd143d2_Out_0.samplerstate, Triplanar_4600f8d10fcb481bb9243c505081d88e_UV.xz);
            float4 Triplanar_4600f8d10fcb481bb9243c505081d88e_Z = SAMPLE_TEXTURE2D(_Property_4b3a3b0c41d7466785460340bbd143d2_Out_0.tex, _Property_4b3a3b0c41d7466785460340bbd143d2_Out_0.samplerstate, Triplanar_4600f8d10fcb481bb9243c505081d88e_UV.xy);
            float4 _Triplanar_4600f8d10fcb481bb9243c505081d88e_Out_0 = Triplanar_4600f8d10fcb481bb9243c505081d88e_X * Triplanar_4600f8d10fcb481bb9243c505081d88e_Blend.x + Triplanar_4600f8d10fcb481bb9243c505081d88e_Y * Triplanar_4600f8d10fcb481bb9243c505081d88e_Blend.y + Triplanar_4600f8d10fcb481bb9243c505081d88e_Z * Triplanar_4600f8d10fcb481bb9243c505081d88e_Blend.z;
            float4 _Remap_96e39547da004b018d33ae02a6e4ff7c_Out_3;
            Unity_Remap_float4(_Triplanar_4600f8d10fcb481bb9243c505081d88e_Out_0, float2 (0, 1), float2 (0.1, 1), _Remap_96e39547da004b018d33ae02a6e4ff7c_Out_3);
            float _Property_7637b3af053149ca95234274aa9fc0f0_Out_0 = Vector1_5528bdf3ce344a5fbed51ae6082bac7d;
            float _Property_f3b5efe6c4424ee288d271adc535717b_Out_0 = Vector1_1d4f7fef1cba451f9cf10522fd3cf41c;
            float _Add_68bfd4b5eeee47929597365765fb3c8c_Out_2;
            Unity_Add_float(_Property_7637b3af053149ca95234274aa9fc0f0_Out_0, _Property_f3b5efe6c4424ee288d271adc535717b_Out_0, _Add_68bfd4b5eeee47929597365765fb3c8c_Out_2);
            float4 _Step_2a515487162f446d9a4231695f7ae3a8_Out_2;
            Unity_Step_float4(_Remap_96e39547da004b018d33ae02a6e4ff7c_Out_3, (_Add_68bfd4b5eeee47929597365765fb3c8c_Out_2.xxxx), _Step_2a515487162f446d9a4231695f7ae3a8_Out_2);
            float4 _Property_0d5dc8268bb340da95844fe8328686b6_Out_0 = Vector4_98655957cd264f8ebfa9f2492dc3c26f;
            float4 _Multiply_a522babea9694f71bb491196fa7aa868_Out_2;
            Unity_Multiply_float(_Step_2a515487162f446d9a4231695f7ae3a8_Out_2, _Property_0d5dc8268bb340da95844fe8328686b6_Out_0, _Multiply_a522babea9694f71bb491196fa7aa868_Out_2);
            AlphaClip_3 = _Property_f85671438b7d45abaf35ef1761c4ba5b_Out_0;
            Alpha_1 = (_Remap_96e39547da004b018d33ae02a6e4ff7c_Out_3).x;
            Emissive_2 = _Multiply_a522babea9694f71bb491196fa7aa868_Out_2;
        }
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            Unity_Multiply_half(_SampleTexture2D_d193981dcfa5c0829b48423600b7a24d_RGBA_0, _Property_37720cf7049ae08289f4ae8b53085aaf_Out_0, _Multiply_8e3164fb1efdbb8ab6fad98c47359f3b_Out_2);
            half4 _Branch_47381574f58f6c8681d309ea31449593_Out_3;
            Unity_Branch_half4(_Property_20d3b24d820d0088ad2a145930e4a35c_Out_0, _Multiply_8e3164fb1efdbb8ab6fad98c47359f3b_Out_2, half4(0, 0, 0, 0), _Branch_47381574f58f6c8681d309ea31449593_Out_3);
            UnityTexture2D _Property_8fe20898f4e24dfcab391ff07582350a_Out_0 = UnityBuildTexture2DStructNoScale(_DissolveNoiseTexture);
            half _Property_fced826a1d47456f92020613a9014adb_Out_0 = _DissolveEffectAmount;
            half _Property_628cfdcda38a48cea88a65e00ebe3e73_Out_0 = _DissolveScale;
            half _Property_bf6239528db54ed19cda1f1e19b20f58_Out_0 = _DissolveEdge;
            half4 _Property_ae678b19cd0e40349622a7b6c558f72e_Out_0 = IsGammaSpace() ? LinearToSRGB(_DissolveColor) : _DissolveColor;
            Bindings_SGDissolve_a81582b475e10fe4486ffab091bc6d5a _SGDissolve_3268a933f1554100a801bfa18cc798ab;
            _SGDissolve_3268a933f1554100a801bfa18cc798ab.WorldSpaceNormal = IN.WorldSpaceNormal;
            _SGDissolve_3268a933f1554100a801bfa18cc798ab.WorldSpacePosition = IN.WorldSpacePosition;
            _SGDissolve_3268a933f1554100a801bfa18cc798ab.AbsoluteWorldSpacePosition = IN.AbsoluteWorldSpacePosition;
            float _SGDissolve_3268a933f1554100a801bfa18cc798ab_AlphaClip_3;
            float _SGDissolve_3268a933f1554100a801bfa18cc798ab_Alpha_1;
            float4 _SGDissolve_3268a933f1554100a801bfa18cc798ab_Emissive_2;
            SG_SGDissolve_a81582b475e10fe4486ffab091bc6d5a(_Property_8fe20898f4e24dfcab391ff07582350a_Out_0, _Property_fced826a1d47456f92020613a9014adb_Out_0, _Property_628cfdcda38a48cea88a65e00ebe3e73_Out_0, _Property_bf6239528db54ed19cda1f1e19b20f58_Out_0, _Property_ae678b19cd0e40349622a7b6c558f72e_Out_0, _SGDissolve_3268a933f1554100a801bfa18cc798ab, _SGDissolve_3268a933f1554100a801bfa18cc798ab_AlphaClip_3, _SGDissolve_3268a933f1554100a801bfa18cc798ab_Alpha_1, _SGDissolve_3268a933f1554100a801bfa18cc798ab_Emissive_2);
            half4 _Add_3a2ddc90c2df4ac5bf10648c9803b173_Out_2;
            Unity_Add_half4(_Branch_47381574f58f6c8681d309ea31449593_Out_3, _SGDissolve_3268a933f1554100a801bfa18cc798ab_Emissive_2, _Add_3a2ddc90c2df4ac5bf10648c9803b173_Out_2);
            ...
            surface.Emission = (_Add_3a2ddc90c2df4ac5bf10648c9803b173_Out_2.xyz);
            ...
            #ifdef SHADER_MODULE_DISSOLVE
                surface.Alpha = _SGDissolve_3268a933f1554100a801bfa18cc798ab_Alpha_1;
                surface.AlphaClipThreshold = _SGDissolve_3268a933f1554100a801bfa18cc798ab_AlphaClip_3;
            #endif
