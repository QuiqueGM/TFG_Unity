...
public class SHD_GridPointEffect : SHD_GridEditor
{
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        _insideSize = ShaderGUI.FindProperty("_InsideSize", properties);
    ...
    private void SectionRimNoise()
    {
        ...
        MaterialEditor.ShaderProperty(_insideSize, new GUIContent("Inside Size"));
    }
}
