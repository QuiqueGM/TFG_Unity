...
{
    public abstract class DC2BaseShaderGUI : ShaderGUI
    {
        ...
        DC2SavedBool m_SurfaceOptionsFoldout;

        DC2SavedBool m_SurfaceInputsFoldout;

        DC2SavedBool m_AdvancedFoldout;
        ...
        public virtual void OnOpenGUI(Material material, MaterialEditor materialEditor)
        {
            ...
            m_SurfaceOptionsFoldout = new DC2SavedBool($"{m_HeaderStateKey}.SurfaceOptionsFoldout", true);
            m_SurfaceInputsFoldout = new DC2SavedBool($"{m_HeaderStateKey}.SurfaceInputsFoldout", true);
            m_AdvancedFoldout = new DC2SavedBool($"{m_HeaderStateKey}.AdvancedFoldout", false);
